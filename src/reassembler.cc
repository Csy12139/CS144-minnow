...
void Reassembler::_insert_to_buffer( uint64_t accept_begin, uint64_t accept_len, uint64_t first_index, string &data)
{
  uint64_t accept_end = accept_begin + accept_len; 
